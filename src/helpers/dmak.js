...
import DmakLoader from "./dmakLoader";

const Dmak = function(text, options) {
  this.text = text;
...
Dmak.fn = Dmak.prototype = {
  ...
  render: function(end) {
    ...
    var cb = function(that) {
        drawStroke(
          that.papers[that.strokes[that.pointer].char],
          that.strokes[that.pointer],
